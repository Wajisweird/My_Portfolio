  ...
  return (
    <div className="container-fluid" id="thirdDiv">
      ...
      <div className="container" id="pp">
        <i className="fa-solid fa-briefcase" id="bc"></i>
        <h6 className="ms-4 my-2" id="dat">
          June 2023 - July 2023
        </h6>
        <h5 className="text-white ms-4">Frontend Developer-Intern</h5>
        <h6 className="text-dark ms-4">Interns Pakistan</h6>
      </div>
      <br />
      <div className="container" id="pp">
        <i className="fa-solid fa-briefcase" id="bc"></i>
      ...
      <div className="container" id="pp">
        <i className="fa-solid fa-briefcase" id="bc"></i>
        <h6 className="ms-4 my-2 text-dark" id="dat">
          September 2023
        </h6>
        <h5 className="text-white ms-4">Frontend Developer-Intern</h5>
        <h6 className="text-dark ms-4">Code Clause</h6>
      </div>
    </div>
  );
}
